...
const features = [
  {
    ...
    description: "Maximum power in a compact form factor, perfect for all applications.",
    icon: Zap,
  },
  {
    name: "Extended Lifespan",
    description: "Engineered for longevity with over 2000+ charge cycles.",
    icon: Battery,
  },
  {
    name: "Safety Certified",
    description: "Built with multiple protection systems and certified safety features.",
    icon: Shield,
  },
  {
    name: "Eco-Friendly",
    description: "100% recyclable components with minimal environmental impact.",
    icon: Recycle,
  },
]
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-muted-foreground">
            Our lithium batteries combine cutting-edge technology with reliable performance,
            delivering power solutions that exceed industry standards.
          </p>
        </div>
