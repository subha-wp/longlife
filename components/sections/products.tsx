...
const products = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        voltage: "48V",
        price: "₹55,999",
        image: "https://images.unsplash.com/photo-1661956602153-23384936a1d3?auto=format&fit=crop&q=80",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        voltage: "48V",
        price: "₹65,999",
        image: "https://images.unsplash.com/photo-1662986327507-f7119a0e2723?auto=format&fit=crop&q=80",
      },
      {
        ...
        voltage: "48V",
        price: "₹75,999",
        image: "https://images.unsplash.com/photo-1671287165224-95a68d7a2dd8?auto=format&fit=crop&q=80",
      },
    ],
  },
]
...
export default function Products() {
  return (
    <section className="py-24 sm:py-32 bg-gradient-to-b from-primary/5 via-transparent to-transparent">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-muted-foreground">
            Choose from our range of high-performance lithium batteries specifically designed for E-rickshaws.
          </p>
        </div>
        ...
        <div className="mt-16">
          <Tabs defaultValue="standard" className="w-full">
            <TabsList className="grid w-full max-w-md mx-auto grid-cols-2 bg-primary/5">
              ...
              <TabsTrigger value="pro" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
                Pro Series
              </TabsTrigger>
            </TabsList>
            {products.map((series) => (
                ...
                <div className="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-2 xl:gap-x-8">
                  {series.items.map((product, index) => (
                    ...
                    >
                      ...
                      <Button className="w-full mt-4 bg-primary hover:bg-primary/90">Get Quote</Button>
                    </motion.div>
                  ))}
                </div>
              </TabsContent>
